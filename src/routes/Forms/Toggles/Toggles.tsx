  ...
  render() {
    return (
      <Container>
        ...
        <p className="mb-4">
          An elegant, accessible toggle component for React. Also a glorified
          checkbox.
        </p>
        <Row>
          <Col lg={6}>
                ...
                <tr>
                  <td>
                    <CustomInput
                      ...
                      onChange={() => {
                        this.setState({
                          toastIsReady: !this.state.toastIsReady,
                        });
                      }}
                ...
                <tr>
                  <td className="d-flex align-items-middle">
                    <Toggle
                      ...
                      onChange={() => {
                        this.setState({
                          biscuitIsReady: !this.state.biscuitIsReady,
                        });
                      }}
                    />
                ...
                <tr>
                  <td className="d-flex align-items-middle">
                    <Toggle
                      ...
                      onChange={() => {
                        this.setState({
                          eggsAreReady: !this.state.eggsAreReady,
                        });
                      }}
                    />
