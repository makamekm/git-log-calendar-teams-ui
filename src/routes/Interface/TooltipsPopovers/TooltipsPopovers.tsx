          ...
          <Card className="mb-3">
            <CardBody className="text-center">
              ...
              <Button
                ...
                outline
                color="secondary"
                id="UncontrolledTooltipTop"
              >
                Show
              </Button>
              <UncontrolledTooltip
                placement="top"
                target="UncontrolledTooltipTop"
              >
                Tooltip Top
              </UncontrolledTooltip>
            </CardBody>
        ...
        <Col lg={3}>
          <Card className="mb-3">
            <CardBody className="text-center">
              ...
              <UncontrolledTooltip
                placement="right"
                target="UncontrolledTooltipRight"
              >
                Tooltip Right
              </UncontrolledTooltip>
            </CardBody>
        ...
        <Col lg={3}>
          <Card className="mb-3">
            <CardBody className="text-center">
              ...
              <UncontrolledTooltip
                placement="bottom"
                target="UncontrolledTooltipBottom"
              >
                Tooltip Bottom
              </UncontrolledTooltip>
            </CardBody>
        ...
        <Col lg={3}>
          <Card className="mb-3">
            <CardBody className="text-center">
              ...
              <UncontrolledTooltip
                placement="left"
                target="UncontrolledTooltipLeft"
              >
                Tooltip Left
              </UncontrolledTooltip>
            </CardBody>
          ...
          <Card className="mb-3">
            <CardBody className="text-center">
              ...
              <Button
                ...
                outline
                color="secondary"
                id="UncontrolledPopoverTop"
              >
                Show
              </Button>
              <UncontrolledPopover
                placement="top"
                target="UncontrolledPopoverTop"
              >
        ...
        <Col lg={3}>
          <Card className="mb-3">
            <CardBody className="text-center">
              ...
              <UncontrolledPopover
                placement="right"
                target="UncontrolledPopoverRight"
              >
        ...
        <Col lg={3}>
          <Card className="mb-3">
            <CardBody className="text-center">
              ...
              <UncontrolledPopover
                placement="bottom"
                target="UncontrolledPopoverBottom"
              >
