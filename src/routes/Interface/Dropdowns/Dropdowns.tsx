      ...
      <Row>
        <Col lg={12}>
          <HeaderDemo
            ...
            subTitle={
              <React.Fragment>Dropdown component states</React.Fragment>
            }
          />
        </Col>
      </Row>
      ...
      <Row>
        <Col lg={12}>
          <HeaderDemo
            ...
            className="mt-5"
            subTitle={
              <React.Fragment>Dropdown header with options</React.Fragment>
            }
          />
        </Col>
      </Row>
            ...
            <CardBody>
              ...
              <UncontrolledButtonDropdown direction="up">
                ...
                <ExtendedDropdown>
                  ...
                  <ExtendedDropdownSection className="text-center">
                    <Link to="/widgets">
