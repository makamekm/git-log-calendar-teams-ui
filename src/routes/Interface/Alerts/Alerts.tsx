        ...
        <Col lg={6}>
          ...
          <div className="mb-4">
            ...
            <Alert color="primary">
              ...
              <span>
                <strong className="alert-heading">Welcome!</strong> We're glad
                to see you again and wish you a nice day.
              </span>
            </Alert>
          </div>
          {/* END Example */}
          ...
          <div className="mb-4">
            ...
            <Alert color="danger">
              ...
              <span>
                <strong className="alert-heading">Danger!</strong> Change a few
          ...
          <div className="mb-4">
            ...
            <Alert color="info">
              ...
              <span>
                <strong className="alert-heading">Information!</strong> This
                alert needs your attention, but it's not important.
              </span>
            </Alert>
          </div>
          {/* END Example */}
        ...
        <Col lg={6}>
          ...
          <div className="mb-4">
            ...
            <Alert color="warning">
              ...
              <span>
                <strong className="alert-heading">Warning!</strong> Better check
          ...
          <div className="mb-4">
            ...
            <Alert color="success">
              ...
              <span>
                <strong className="alert-heading">Success!</strong> You
          ...
          <div className="mb-4">
            ...
            <Alert color="dark">
              ...
              <span>
                <strong className="alert-heading">Attention!</strong> This alert
                needs your attention, but it's not important.
              </span>
            </Alert>
          </div>
          {/* END Example */}
