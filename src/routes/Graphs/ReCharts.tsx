...
export const ReCharts = () => (
  <Container>
    ...
    <p>
      Recharts is a Redefined chart library built with React and D3. The main
      purpose of this library is to help you to write charts in React
    ...
    <ul className="mb-5">
      ...
      <li>
        <strong>Native</strong> SVG support, lightweight depending only on some
        D3 submodules
      </li>
      <li>
        <strong>Declarative</strong> components, components of charts are purely
        presentational
      </li>
    </ul>
    ...
    <Row>
      <Col lg={12}>
        <HeaderDemo
          ...
          subTitle={
            <React.Fragment>
              Quickly build your charts with decoupled, reusable React
              components.
            </React.Fragment>
          }
        />
