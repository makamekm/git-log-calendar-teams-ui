      ...
      <Row>
        <Col lg={12}>
          <HeaderSection
            ...
            subTitle={
              <React.Fragment>
                All table styles are inherited in Bootstrap 4, meaning any
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="mb-0">
                ...
                <code>.table-based</code> tables look in Bootstrap. All table
                styles are inherited in Bootstrap 4, meaning any nested tables
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="mb-0">
                ...
                a <code>Table</code> with <code>responsive</code>.
              </p>
            </CardBody>
            {/* START Table */}
            <Table className="mb-0" responsive>
        ...
        <Col lg={12}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="mb-0">
                Use <code>striped</code> to add zebra-striping to any table row
        ...
        <Col lg={12}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Add <code>bordered</code> for borders on all sides of the table
                and cells.
              </p>
              {/* START Table */}
          ...
          <Card className="mb-3" type="background" color="dark">
            <CardBody>
              ...
              <p className="mb-0">
                ...
                backgrounds—with <code>dark</code>.
              </p>
            </CardBody>
            {/* START Table */}
