        ...
        <Col lg={8}>
          <UncontrolledTabs initialActiveTabId="overview">
            ...
            <Nav pills className="mb-4 flex-column flex-md-row mt-4 mt-lg-0">
              <NavItem>
                <UncontrolledTabsNavLink tabId="overview">
                  Overview
                </UncontrolledTabsNavLink>
              </NavItem>
              <NavItem>
                <UncontrolledTabsNavLink tabId="detailContact">
                  Detail Contact
                </UncontrolledTabsNavLink>
              </NavItem>
              <NavItem>
                <UncontrolledTabsNavLink tabId="chat">
                  Chat
                </UncontrolledTabsNavLink>
              </NavItem>
              <NavItem>
                <UncontrolledTabsNavLink tabId="messages">
                  Messages{" "}
