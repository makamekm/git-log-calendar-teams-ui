...
export const Typography = () => (
  <React.Fragment>
    <Container>
      <HeaderMain title="Typography" className="mb-5 mt-4" />
      {/* START Header 1 */}
      <Row>
        <Col lg={12}>
          <HeaderSection
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                Use any of these color variables as they are or reassign them to
                more meaningful variables for your project.
              </p>
              <div>
                <p className="text-secondary">
                  This is an example for <code>.text-secondary</code>
                </p>
        ...
        <Col lg={6}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                Grayscale colors provide quick access to commonly used shades of
                black while semantic include various colors assigned to
        ...
        <Col lg={6}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                Just add class/helper <code>.fw-300</code> to{" "}
                <code>&lt;h1&gt;</code>- <code>&lt;h6&gt;</code>.
              </p>
              <div>
                <h1 className="mb-2 fw-300">h1. Light Heading</h1>
                <h2 className="fw-300">h2. Light Heading</h2>
                <h3 className="fw-300">h3. Light Heading</h3>
                <h4 className="fw-300">h4. Light Heading</h4>
                <h5 className="fw-300">h5. Light Heading</h5>
                <h6 className="fw-300">h6. Light Heading</h6>
              </div>
            </CardBody>
          </Card>
          <Card className="mb-3">
        ...
        <Col lg={6}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                In the case of Regular is from set as default in{" "}
                <code>.scss</code>.
              </p>
              <div>
                <h1 className="mb-0">h1. Regular Heading</h1>
                <h2>h2. Regular Heading</h2>
                <h3>h3. Regular Heading</h3>
                <h4>h4. Regular Heading</h4>
                <h5>h5. Regular Heading</h5>
                <h6>h6. Regular Heading</h6>
              </div>
            </CardBody>
          </Card>
          <Card className="mb-3">
            <CardBody>
              ...
              <div>
                <h1 className="mb-0">
                  h1. Custom
                  <small className="text-muted">with Small Text</small>
                </h1>
                <h2>
                  h2. Custom
                  <small className="text-muted">with Small Text</small>
        ...
        <Col lg={6}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                Add class <code>.text-left</code>,<code>.text-center</code> or
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                ...
                <strong>Requires</strong> display:
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <div>
                <p className="card-text">
                  Quickly change the weight (boldness) of text or italicize
                  text.
                </p>
        ...
        <Col lg={6}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                Wrap <code>&lt;blockquote className="blockquote" /&gt;</code>{" "}
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                ...
                combination of two classes, <code>.list-inline</code> and
        ...
        <Col lg={6}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                Wrap inline snippets of code with <code>&lt;code&gt;</code>. Be
                sure to escape HTML angle brackets.
              </p>
            </CardBody>
          </Card>
          <Card className="mb-3">
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                Use the <code>&lt;kbd&gt;</code> to indicate input that is
        ...
        <Col lg={6}>
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Code: Sample Output
                <span className="small ml-1 text-muted">#6.05</span>
              </CardTitle>
              <p className="card-text">
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                Use <code>&lt;pre&gt;</code>s for multiple lines of code. Once
                again, be sure to escape any angle brackets in the code for
                proper rendering. You may optionally add the{" "}
                <code>.pre-scrollable</code> class, \ which will set a
                max-height of 340px and provide a y-axis scrollbar.
              </p>
              <code>
                &lt;p&gt;Sample text here...&lt;/p&gt; &lt;p&gt;And another line
                of sample text here...&lt;/p&gt;
              </code>
            </CardBody>
          </Card>
        </Col>
