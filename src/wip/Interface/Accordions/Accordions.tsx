      ...
      <Row>
        ...
        <Col lg={6}>
          ...
          <div className="mb-5">
            ...
            <p>
              ...
              <code>Card</code>, <code>h6</code>, and{" "}
              <code>UncontrolledCollapse</code>.
            </p>
          ...
          <div className="mb-5">
            ...
            <Accordion className="mb-2" initialOpen>
              <AccordionHeader>Accordion Card #1</AccordionHeader>
              <AccordionBody>
                <CardText>{faker.lorem.paragraph()}</CardText>
              </AccordionBody>
            </Accordion>
        ...
        <Col lg={6}>
          ...
          <div className="mb-5">
            ...
            <Accordion className="mb-2" initialOpen>
              <AccordionHeader className="d-flex h6">
                <span>Accordion Card #1</span>
                <AccordionIndicator className="ml-auto" />
              </AccordionHeader>
              <AccordionBody>
                <CardText>{faker.lorem.paragraph()}</CardText>
              </AccordionBody>
          ...
          <div className="mb-5">
            ...
            <Accordion className="mb-2" initialOpen>
              <AccordionHeader className="d-flex align-items-center h6">
                <span>
      ...
      <Row>
        <Col lg={6}>
          ...
          <div className="mb-5">
            ...
            <Accordion className="mb-2">
              <AccordionHeader className="text-success">
                Success Card #2
              </AccordionHeader>
              <AccordionBody>
                <CardText>{faker.lorem.paragraph()}</CardText>
            ...
            <Accordion className="mb-2">
              <AccordionHeader className="text-danger">
                Danger Card #3
              </AccordionHeader>
              <AccordionBody>
                <CardText>{faker.lorem.paragraph()}</CardText>
