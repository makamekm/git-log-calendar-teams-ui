        ...
        <Card className="mb-3 text-center">
          <CardBody>
            ...
            <UncontrolledModal target="modalDefault101">
              ...
              <ModalFooter>
                <UncontrolledModalClose color="link" className="text-primary">
                  Close
                </UncontrolledModalClose>
                <UncontrolledModalClose color="primary">
                  Save
                </UncontrolledModalClose>
              </ModalFooter>
            </UncontrolledModal>
        ...
        <CardBody>
          ...
          <UncontrolledModal target="modalDefault201" size="sm">
            ...
            <ModalFooter>
              ...
              <UncontrolledModalClose color="primary" size="sm">
                Save
              </UncontrolledModalClose>
            </ModalFooter>
          </UncontrolledModal>
        ...
        <CardBody>
          ...
          <UncontrolledModal target="modalDefault203" size="lg">
            ...
            <ModalFooter>
              ...
              <UncontrolledModalClose color="primary" size="lg">
                Save
              </UncontrolledModalClose>
            </ModalFooter>
          </UncontrolledModal>
        ...
        <Card className="mb-3 text-center">
          <CardBody>
            ...
            >
              ...
              <ModalBody>{faker.lorem.paragraph()}</ModalBody>
              <ModalFooter>
                <UncontrolledModalClose color="link">
                  Close
                </UncontrolledModalClose>
                <UncontrolledModalClose color="primary">
                  Save
          ...
          <CardBody>
            ...
            >
              ...
              <ModalFooter>
                ...
                <UncontrolledModalClose color="danger">
                  Save
                </UncontrolledModalClose>
              </ModalFooter>
            </UncontrolledModal>
        ...
        <Card className="mb-3 text-center">
          <CardBody>
            ...
            >
              ...
              <ModalBody>{faker.lorem.paragraph()}</ModalBody>
              <ModalFooter>
                <UncontrolledModalClose color="link" className="text-info">
                  Close
                </UncontrolledModalClose>
                <UncontrolledModalClose color="info">
                  Save
                </UncontrolledModalClose>
              </ModalFooter>
            </UncontrolledModal>
        ...
        <Card className="mb-3 text-center">
          <CardBody>
            ...
            >
              ...
              <ModalBody>{faker.lorem.paragraph()}</ModalBody>
              <ModalFooter>
                <UncontrolledModalClose color="link" className="text-warning">
                  Close
                </UncontrolledModalClose>
                <UncontrolledModalClose color="warning">
                  Save
                </UncontrolledModalClose>
              </ModalFooter>
            </UncontrolledModal>
        ...
        <Card className="mb-3 text-center">
          <CardBody>
            ...
            >
              ...
              <ModalBody>{faker.lorem.paragraph()}</ModalBody>
              <ModalFooter>
                <UncontrolledModalClose color="link" className="text-success">
                  Close
                </UncontrolledModalClose>
                <UncontrolledModalClose color="success">
                  Save
                </UncontrolledModalClose>
              </ModalFooter>
            </UncontrolledModal>
        ...
        <Card className="mb-3 text-center">
          <CardBody>
            ...
            >
              ...
              <ModalBody>{faker.lorem.paragraph()}</ModalBody>
              <ModalFooter>
                <UncontrolledModalClose color="link" className="text-dark">
                  Close
                </UncontrolledModalClose>
                <UncontrolledModalClose color="dark">
                  Save
                </UncontrolledModalClose>
              </ModalFooter>
            </UncontrolledModal>
          ...
          <CardBody className="table-primary">
            ...
            >
              ...
              <ModalBody className="text-center px-5">
                ...
                <UncontrolledModalClose color="primary" className="mr-2">
                  Save
                </UncontrolledModalClose>
                <UncontrolledModalClose color="link" className="text-primary">
                  Close
          ...
          <CardBody className="table-danger">
            ...
            >
              ...
              <ModalBody className="table-danger text-center px-5">
                ...
                <UncontrolledModalClose color="danger" className="mr-2">
                  Save
                </UncontrolledModalClose>
                <UncontrolledModalClose color="link" className="text-danger">
                  Close
          ...
          <CardBody className="table-info">
            ...
            <UncontrolledModal target="modalDefault403" className="modal-info">
              ...
              <ModalBody className="table-info text-center px-5">
                ...
                <UncontrolledModalClose color="info" className="mr-2">
                  Save
                </UncontrolledModalClose>
                <UncontrolledModalClose color="link" className="text-info">
                  Close
          ...
          <CardBody className="table-warning">
            ...
            >
              ...
              <ModalBody className="table-warning text-center px-5">
                ...
                <UncontrolledModalClose color="warning" className="mr-2">
                  Save
                </UncontrolledModalClose>
                <UncontrolledModalClose color="link" className="text-warning">
                  Close
          ...
          <CardBody className="table-success">
            ...
            >
              ...
              <ModalBody className="table-success text-center px-5">
                ...
                <UncontrolledModalClose color="success" className="mr-2">
                  Save
                </UncontrolledModalClose>
                <UncontrolledModalClose color="link" className="text-success">
                  Close
          ...
          <CardBody className="table-light">
            ...
            <UncontrolledModal target="modalDefault406" className="modal-dark">
              ...
              <ModalBody className="table-light text-center px-5">
                ...
                <UncontrolledModalClose color="secondary" className="mr-2">
                  Save
                </UncontrolledModalClose>
                <UncontrolledModalClose color="link" className="text-secondary">
                  Close
                </UncontrolledModalClose>
              </ModalBody>
              <ModalFooter className="py-3" />
